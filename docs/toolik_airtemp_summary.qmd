...
#clean names come from janitor package
...
skimr::skim("toolik_chrolophyll")

dim("toolik_chrolophyll")
names("toolik_chrolophyll")
...
#replace missing values as a
na_if(toolik_chlorophyll$active_chl_a_ug_l, ".")

#convert chlorophyll data into nummeric
...
ggplot(data = toolik_chlorophyll,
  ...
  geom_point() +
  theme_minimal() +
  labs(title = "Toolik Chlorophyll a Concentration",
         x = "Depth (m)",
